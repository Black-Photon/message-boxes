...
This does NOT mean any whole project including this folder is free to use, only that the distribution of this folder is not limited.
For more info, see the github page, it has essentially everything.